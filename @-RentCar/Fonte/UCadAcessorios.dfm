object frmAcessorios: TfrmAcessorios
  Left = 298
  Top = 215
  Width = 651
  Height = 240
  Caption = '@-RentCar - Cadastro de Acess'#243'rios'
  Color = clBtnFace
  ...
  object pgcAcessorio: TPageControl
    ...
    object tsTipoAcessorios: TTabSheet
      ...
      object Label1: TLabel
        ...
        Width = 92
        Height = 13
        Caption = 'Nome do Acess'#243'rio'
      end
      object DBEAcessorio: TDBEdit
        Left = 8
        Top = 38
        Width = 201
        Height = 21
        DataField = 'Acess'#243'rio'
        DataSource = dmRentCar.dsTTipoAcessorios
        TabOrder = 0
      end
      object DBGTipoAcessorio: TDBGrid
        Left = 236
        Top = 35
        Width = 378
        Height = 126
    ...
    object tsAddAcessorios: TTabSheet
      ...
      object lblEspec: TLabel
        ...
        Width = 161
        Height = 13
        Caption = 'Especifica'#231#245'es do Ve'#237'culo :'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
