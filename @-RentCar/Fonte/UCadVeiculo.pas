...
var
  aDest :TBitmap;
begin
 DBREspec.Text := 'Carro :  '+DBEModelo.Text +' Ano : '+DBCBAno.Text +' Marca: '+DBEMarca.Text +' Cor : '+DBECor.Text;
...
begin
 ...
 ZQFunctions.SQL.Add('select distinct vel_ano from rentcar_veiculo');
 ZQFunctions.Open;
 while  not ZQFunctions.Eof do
 Begin
 DBCBAno.Items.Add(ZQFunctions.fieldbyname('vel_ano').AsString);
 ZQFunctions.Next;
 end;
 end;
end;
