...
begin
 ConeccaoEmail();
  ...
  if frmRentCarPrincipal.veiculo = 'PFL' then
  Begin
   mensagem := 'Srº '+dmRentCar.ZTPesFisPesFis_Nome.AsString+' informamos que a locação do veículo '+''+'foi realizada e computada no nosso sistema com sucesso';
 end else
  if frmRentCarPrincipal.veiculo = 'PJL' then
  Begin
    mensagem := 'Srº '+dmRentCar.ZTPesJuPesJu_NmFantasia.AsString+' informamos que a locação do veículo '+''+'foi realizada e computada no nosso sistema com sucesso';
  end;
...
begin
 ...
 Begin
  mensagem := 'Srº '+dmRentCar.ZTPesFisPesFis_Nome.AsString+' informamos que a foi feita a reserva do veículo '+''+'com sucesso, em breve informaremos quando o veículo estiver disponível';
 end else
 if frmRentCarPrincipal.veiculo = 'PJR' then
 Begin
  mensagem := 'Srº '+dmRentCar.ZTPesJuPesJu_NmFantasia.AsString+' informamos que a foi feita a reserva do veículo '+''+'com sucesso, em breve informaremos quando o veículo estiver disponível';
 end;
